...
func GenerateObjects(testW *os.File, objectsRaw []byte) {
	...
	if testW != nil {
		if testW.Name() == "api/gen/tests/objects_test.go" {
			writeStartFile(testW, "tests", "", "github.com/defany/govk/api/gen/models", "encoding/json", "github.com/defany/govk/pkg/random")
		} else {
			writeStartFile(testW, "tests", "", "github.com/defany/govk/api/gen/models", "github.com/defany/govk/pkg/random")
		}
	}
